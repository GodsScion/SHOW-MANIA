...
export interface Show {
    ...
    status?: string, //"Ended",
    runtime?: number | null, //60,
    averageRuntime?: number, //60,
    premiered?: string, //"2013-06-24",
    ended?: string | null, //"2015-09-10",
    officialSite?: string | null, //"http://www.cbs.com/shows/under-the-dome/",
    schedule?: {
        time?: string, //"22:00",
    ...
    network?: {
        ...
        officialSite?: string | null, //"https://www.cbs.com/"
    } | null,
    webChannel?: any, //null,
    dvdCountry?: any, //null,
    externals?: {
    ...
    _links?: {
        ...
        nextepisode?: {
            href?: string, //"https://api.tvmaze.com/episodes/2662187",
